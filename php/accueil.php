...
<div id="ecole">
  <div id="presentation">
    <i id="attention"><br><br>/!\ Ce site est en cours de développement.  Il s’agit d’un projet entièrement mené par deux élèves ingénieurs de première année depuis Mars 2017. /!\</i>
    <p><br><br>L'Ecole Nationale des Sciences Géographiques fait partie du panel des Grandes Écoles d'Ingénieurs de France, située sur le campus Descartes à Marne-la-Vallée.</p>
    ...
    <p>Pour plus de précision sur ces différentes formations et leur intégration, <a target="_blank" href="http://ensg.eu">clique ici</a>.</p>
    <h3>Campus</h3>
    <p>L’ENSG est entourée d’autres grandes écoles et universités prestigieuses parmi lesquelles : l’Université Paris Est Marne-la-Vallée, l’ESIEE, l’Ecole d’Urbanisme de Paris et l’Ecole Nationale des Ponts et Chaussées. La proximité géographique de ces écoles donne l’occasion à de nombreuses rencontres dans le cadre des cours, mais aussi en dehors lors de défis sportifs comme le Trophée Descartes ou lors de la plus grosse soirée étudiante de l’Est parisien, la Nuit Descartes.</p>
